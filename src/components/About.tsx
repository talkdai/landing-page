    ...
    <div className="min-h-screen bg-black text-white p-4 md:p-16 flex flex-col items-center">
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-start justify-center mt-12 mx-4 md:mx-8 mb-24 gap-8 md:gap-16">
        <div className="md:w-7/12 w-full flex-grow text-left">
          ...
          <p className="text-base md:text-xl text-gray-400 font-medium mb-4">
            talkd.ai is a project led by{" "}
            <a href="https://www.linkedin.com/in/vmesel/" target="_blank">
              Vinicius Mesel
            </a>{" "}
            and advised by{" "}
            <a href="https://linkedin.com/in/avelinorun" target="_blank">
              Thiago Avelino
            </a>
            . It focuses on developing conversational AI solutions to improve
            communication and streamline business processes. With their combined
            expertise in AI and software development, the maintainers aim to
            make advanced technology more accessible and practical for various
            applications.
          </p>
          <br />
          ...
          <ul className="list-disc list-inside text-base md:text-xl text-gray-400 font-medium mb-4 pl-2">
            <li>
              <a href="https://github.com/buserbrasil" target="_blank">
                Buser
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="https://thesamba.capital/" target="_blank">
                The Samba Capital
              </a>
            </li>
          </ul>
          ...
          <p className="text-base md:text-xl text-gray-400 font-medium mb-4">
            ...
            continue to help us improve our code base. Some highlights include:
          </p>
          <ul className="list-disc list-inside text-base md:text-xl text-gray-400 font-medium mb-4 pl-2">
            <li>
              <a href="https://github.com/lgabs" target="_blank">
                Luan Fernandes
              </a>
            </li>
            <li>
              <a href="https://github.com/walison17" target="_blank">
                Walison Filipe
              </a>
            </li>
          </ul>
